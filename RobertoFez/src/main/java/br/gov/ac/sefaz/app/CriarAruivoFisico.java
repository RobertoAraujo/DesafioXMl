...
public class CriarAruivoFisico {
	...
	public static void main(String[] args) {
		...
		uti.marshalToFile(ped, "/home/bruno/eclipse-workspace/RobertoFez/src/main/resources/pedido.xml");
		System.out.println("Aquivo Gerado");
